    ...
    <footer className="bg-black text-white py-8 px-4 text-center text-sm">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 text-xs text-gray-400">
          <p className="mb-2"><strong>TODOS LOS DERECHOS RESERVADOS.</strong> NO CREAMOS NI PROMOVEMOS PRODUCTOS PARA CAMBIAR DE VIDA DE LAS PERSONAS DE LA NOCHE A LA MAÑANA. TAMPOCO PODEMOS PROMETER RESULTADOS Y ADVERTIMOS QUE NUESTROS RESULTADOS O LOS RESULTADOS DE TESTIMONIALES NO SON RESULTADOS TÍPICOS Y NO SIGNIFICA QUE QUIEN CONTRATE NUESTROS PRODUCTOS O SERVICIOS PUEDA CONSEGUIR RESULTADOS SIMILARES. ES POSIBLE QUE NO CONSIGA NINGÚN RESULTADO, ESPECIALMENTE SI NO PONE EN PRÁCTICA LO QUE APRENDE.</p>
          
          <p>THIS SITE IS NOT A PART OF THE FACEBOOK WEBSITE OR FACEBOOK INC. ADDITIONALLY, THIS SITE IS NOT ENDORSED BY FACEBOOK IN ANY WAY. FACEBOOK IS A TRADEMARK OF FACEBOOK, INC. ESTA PÁGINA NO ES PARTE DE FACEBOOK. FACEBOOK ES UNA MARCA REGISTRADA DE FACEBOOK.</p>
        </div>
