...
return (
  <div className="flex flex-col min-h-screen bg-white dark:bg-white text-[#262626] dark:text-[#262626] font-poppins">
    ...
    <main className="flex-grow">
      {/* Updated Hero Section with new heading */}
        ...
        <section id="reviews" className="mb-20 text-center">
          ...
          <div className="flex overflow-x-auto space-x-6 pb-4">
            {reviews.map((review, index) => (
              <div key={index} className="flex-shrink-0 w-80 border-2 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 bg-white dark:bg-white" style={{ borderColor: ['#E56399', '#33658A', '#29A2AF'][index] }}>
